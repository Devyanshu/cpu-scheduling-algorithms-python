...
generate=Button(frame,text="Generate",fg="black",font=('arial',8,'bold'),width=10,height=1,command=table_win).grid(row=5,column=0)
compute=Button(frame,text="Compute",fg="black",font=('arial',8,'bold'),width=10,height=1).grid(row=5,column=2)
exit_button=Button(frame,text="Exit",fg="black",font=('arial',8,'bold'),width=10,height=1,command=root.destroy).grid(row=5,column=3)
